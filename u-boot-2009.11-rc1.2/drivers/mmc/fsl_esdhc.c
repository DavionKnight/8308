...
void set_sysctl(struct mmc *mmc, uint clock)
{
	...
	setbits_be32(&regs->sysctl, SYSCTL_CLKEN | SYSCTL_PEREN);
#else
...
#if defined(CONFIG_MPC8308)
	out_be32(CONFIG_SYS_SDHC_CTRL_ADDR, 0x2000000);
	out_be32(&regs->sysctl, SYSCTL_CLKEN|SYSCTL_HCKEN | SYSCTL_IPGEN);
#else
