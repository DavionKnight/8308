...
#define CONFIG_SYS_LBC_LBCR		0x00040800
...
#define CONFIG_SYS_FLASH_BR_PRELIM	(CONFIG_SYS_FLASH_BASE	/* Flash Base address */ \
				...
				| BR_V )		/* valid */
				// 0xFE000000 | 0x00010000 | 0x00000001 = 0xFE010001
#define CONFIG_SYS_FLASH_OR_PRELIM	((~(CONFIG_SYS_FLASH_SIZE - 1) << 20) \
				...
				| OR_GPCM_EHTR \
				| OR_GPCM_EAD )
				// 0xF800000 | 0x00006000 | 0x00000800 | 0x00000600 | 0x00000100 | 0x000000f0 | 0x00000004 | 0x00000002 | 0x00000001  = 0xF8006FF7
 ...
 */
//#if defined(CONFIG_NAND_U_BOOT) && !defined(CONFIG_MPC8308_HH_EDD_RAM)
...
#define CONFIG_SYS_NAND_U_BOOT_START	(CONFIG_SYS_NAND_U_BOOT_DST + 0x120)
#define CONFIG_SYS_NAND_U_BOOT_OFFS		CONFIG_SYS_NAND_BLOCK_SIZE
#define CONFIG_SYS_NAND_U_BOOT_RELOC	0x00010000

/* NAND boot: 4K NAND loader config */
/*
#define CONFIG_SYS_NAND_SPL_SIZE		0x4000
#define CONFIG_SYS_NAND_U_BOOT_SIZE		((512 << 10) - 0x2000)
#define CONFIG_SYS_NAND_U_BOOT_DST		(0x01000000)
#define CONFIG_SYS_NAND_U_BOOT_START 	(CONFIG_SYS_NAND_U_BOOT_DST + CONFIG_SYS_NAND_SPL_SIZE + 0x120)
...
#define CONFIG_VSC7385_ENET			/* VSC7385 ethernet support, it's a switch chip */
