/*
 * Copyright (C) 2004-2007, 2009 Freescale Semicondutor, Inc. All rights reserved.
 *
...
{
	unsigned int tmp = 0, portctrl = 0, ctrl = 0, ep_num;
...
#define FSL_UDC_RESET_TIMEOUT 1000
	...
	/*A note in RM says that unused endpoint must be configured as BULK */
