...
#define TMR_CTRL_TCLK_PRD	0x00080000 /* Nominal Freq = 125 MHz */
#define TMR_OSC_FREQ		166666667
...
struct gfar {
	...
	u8	res23d[32];
	u32	rfbptr[16];	/* 0x.c40 - Last Free RxBD pointer */
	u8	res24[384];
...
#define FSL_GIANFAR_DEV_HAS_MDIO		0x00000800
...
extern int fsl_sleep_init(struct fsl_sleep_platform_data *sleep,
		struct device_node *node);
